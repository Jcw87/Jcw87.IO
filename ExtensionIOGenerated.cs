...
namespace Jcw87.IO
{
    ...
    public static partial class ExtensionIO
    {
        ...
        public static void WriteLE(this byte[] bytes, int offset, Int16 value)
        {
            ...
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(Int16));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(Int32));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(Int64));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(UInt16));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(UInt32));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(UInt64));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(Single));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsLE) Array.Reverse(bytes, offset, sizeof(Double));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(Int16));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(Int32));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(Int64));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(UInt16));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(UInt32));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(UInt64));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(Single));
        }
        ...
        {
            BitConverter2.GetBytes(value, bytes, offset);
            if (!IsBE) Array.Reverse(bytes, offset, sizeof(Double));
        }
